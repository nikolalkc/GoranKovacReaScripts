...
local help_tbl = {
    ...
    "\t\tTab          - Opens Api Menu (same as Right Click)",
    "\tALIGN (2+ selected nodes) :",
    "\t\tShift + A/D   - Align Left / Right edges",
    "\t\tShift + W/S   - Align Top / Bottom edges",
    "\t\tAlt+Shift + S - Center horizontally",
    "\t\tAlt+Shift + W - Center vertically",
    "\t\tQ             - Straighten (line up centers)",
    "\tGRID :",
    "\t\tToggle with the GRID checkbox in the top toolbar",
    "\t\tWhen ON, dragged nodes snap to grid on release",
    "\n",
    "SIDEBAR :",
